...
OG_PROMPT_CORE = (
    ...
    "Force a hand positioned in a cleanch fist with the knuckles facing the camera next to one of their cheeks and about the same length in foream to be showing off the watch"
